...
/**
 * Evaluates temporal (dynamic) networks by processing each time slice sequentially.
 * For each slice, the utility potentials are evaluated using variable elimination,
 * producing a utility potential per time slice plus an atemporal utility component.
 */
public class TemporalEvaluation extends VariableElimination {
    ...
    // Resulting utilities
    private List<Potential> utilityPotentialsPerSlice = null;
    private Potential atemporalUtility = null;
     ...
     */
    public TemporalEvaluation(ProbNet network) throws NotEvaluableNetworkException.NotApplicableNetwork, NotEvaluableNetworkException.UnsatisfiedConstraints, ConstraintViolatedException {
        super(network);
        ...
        // pre-process steps
        this.isTemporal = !probNet.hasConstraintOfClass(OnlyAtemporalVariables.class);
    ...
    public void resolve() throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther, NonProjectablePotentialException {
     ...
     */
    public void evaluateNetwork(ProbNet probNet) {
    ...
    public List<Potential> getUtilityPotentialsPerSlice() throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther, NonProjectablePotentialException {
    ...
    public Potential getAtemporalUtility() throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther, NonProjectablePotentialException {
