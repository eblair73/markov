...
public class DANDecisionTreeInference extends DANInference implements DecisionTreeComputation {
    ...
    public DANDecisionTreeInference(ProbNet probNet, boolean isCEA) throws NotEvaluableNetworkException, NonProjectablePotentialException, IncompatibleEvidenceException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
    ...
    public DANDecisionTreeInference(ProbNet probNet, int treeDepth, boolean computeDecisionTreeForGUI2) throws NotEvaluableNetworkException, IncompatibleEvidenceException, NonProjectablePotentialException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
    ...
    public DANDecisionTreeInference(ProbNet probNet, EvidenceCase evidenceCase, boolean computeDecisionTreeForGUI,
                                    boolean isCEA) throws NotEvaluableNetworkException, IncompatibleEvidenceException, NonProjectablePotentialException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
    ...
    public DANDecisionTreeInference(ProbNet probNet, int treeDepth, boolean computeDecisionTreeForGUI2,
                                    EvidenceCase evidenceCase) throws NotEvaluableNetworkException, IncompatibleEvidenceException, NonProjectablePotentialException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
    ...
    protected DANDecisionTreeInference(ProbNet dan, EvidenceCase evidenceCase, int maximumTreeDepth,
                                       int currentTreeDepth, boolean computeDecisionTreeForGUI, boolean isCEA) throws NotEvaluableNetworkException, IncompatibleEvidenceException, NonProjectablePotentialException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
        super(dan, isCEA);
    ...
    private static void setDANNameFromEvidence(ProbNet dan, EvidenceCase evidence) {
        if (evidence != null) {
     ...
     * @param maximumTreeDepth the maximum tree depth
     * @param childTreeDepth the child tree depth
     * @param x the index
    ...
    private void childEvaluationDecisionTree(ProbNet dan, EvidenceCase evidenceCase, int maximumTreeDepth,
                                             int childTreeDepth, Variable x, State state) throws NotEvaluableNetworkException, IncompatibleEvidenceException, NonProjectablePotentialException, PotentialOperationException.DifferentSizesInPotentialsAndStates {
        DANDecisionTreeInference auxEval = constructDecisionTreeInference(dan, evidenceCase, maximumTreeDepth, childTreeDepth);
    ...
    public static StrategyTree getOptimalStrategyTree() {
        return null;
    }
