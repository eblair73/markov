...
public class VECEPSA extends VariableElimination implements CE_PSA {
     ...
     */
    public VECEPSA(ProbNet network) throws NotEvaluableNetworkException.NotApplicableNetwork, NotEvaluableNetworkException.UnsatisfiedConstraints, ConstraintViolatedException {
        super(network);
    ...
    private class Simulation implements Callable<GTablePotential> {
        ...
        @Override
        public GTablePotential call() throws IncompatibleEvidenceException, NonProjectablePotentialException, NotEvaluableNetworkException.NotApplicableNetwork, NotEvaluableNetworkException.UnsatisfiedConstraints, ConstraintViolatedException {
            sampleNetworkPotentials(probNet);
            CEAnalysis veEvaluation = new VECEAnalysis(probNet);
            veEvaluation.setPreResolutionEvidence(getPreResolutionEvidence());
