...
public abstract class StochasticPropagation extends InferenceAlgorithm implements Propagation {
    ...
    StochasticPropagation(ProbNet probNet) throws NotEvaluableNetworkException.NotApplicableNetwork, NotEvaluableNetworkException.UnsatisfiedConstraints, ConstraintViolatedException {
        super(probNet);
     ...
     * It returns the posterior values and, if {@code storingSamples} is true,
     * stores the samples in the variable {@code samples} .
     *
    ...
    public HashMap<Variable, TablePotential> getPosteriorValues() throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther, IncompatibleEvidenceException.SamplesWeightIsZero, NonProjectablePotentialException {
        ...
        if (accumulatedWeight == 0) {
            throw new IncompatibleEvidenceException.SamplesWeightIsZero(samples);
        }
        ...
        for (int i = 0; i < numOfVariablesOfInterest; i++) {
            ...
            posteriorProbability.setValues(accumulatedValues);
