...
public class LogicSampling extends StochasticPropagation {
    
    public LogicSampling(ProbNet probNet) throws NotEvaluableNetworkException.NotApplicableNetwork, NotEvaluableNetworkException.UnsatisfiedConstraints, ConstraintViolatedException {
		super(probNet);
	}
