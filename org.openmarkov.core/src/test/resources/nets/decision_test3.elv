...
kind-of-relation = potential;
deterministic=false;
values= table (0.0 1.0 0.0 1.0 0.91 0.0 0.03 0.0 0.09 0.0 0.97 0.0 );
}
...
deterministic=false;
values= table (80.0 30.0 90.0 100.0 );
}
...
kind-of-relation = utility;
deterministic=false;
values= table (-2.0 0.0 );
}

relation U Treatment_D { 
comment = "";
kind-of-relation = utility;
deterministic=false;
values= table (40.0 60.0 );
}

relation Global_utility_U0 Cost_of_test_U2 Quality_of_life_U1 U { 
comment = "";
