...
@SuppressWarnings("ALL") public class ArffParser extends antlr.LLkParser implements ArffLexerTokenTypes {
    
    public static final String[] _tokenNames = {"<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "QUOTATION", "COMMA",
            "LEFTB", "RIGHTB", "WHITE", "REMARK", "SEPARATOR", "IDENT", "STRING", "RELATION", "ATTRIBUTE", "DATA"};
     ...
     * Messages file
     */
    private Logger logFile = LogManager.getLogger(ArffParser.class);
     ...
     */
    public Node addNode(LinkedHashMap<String, String> infoNode, State[] states, NodeType nodeType, String nodeName) {
        ...
        Node node = probNet.addNode(fsVariable, nodeType);
    ...
    public final void attribute() throws RecognitionException, TokenStreamException {
        ...
        Token id2 = null;
        AST id2_AST = null;
        LinkedHashMap<String, String> infoNode = null;
        ...
        try {      // for error handling
            ...
            infoNode = new LinkedHashMap<String, String>();
            Node node;
            ...
            if (id1 != null)
                node = addNode(infoNode, states, typeOfNode, id1.getText());
            else
                node = addNode(infoNode, states, typeOfNode, id2.getText());
    ...
    public final int caseData() throws RecognitionException, TokenStreamException {
        ...
        try {      // for error handling
            ...
            try {
                Token lcommon = l1 != null ? l1 : l2;
                int stateIndex = fsVariables.get(index).getStateIndex(lcommon.getText());
                if (stateIndex != -1) {
                    example[index] = stateIndex;
                }
                index++;
